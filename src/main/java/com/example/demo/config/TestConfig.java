...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		UserCommonClient u1 = new UserCommonClient(null, "bob@gmail.com", "fff",AcessType.CLIENT , "23232323", "97979797", "Bob");
		UserAdmin u2 = new UserAdmin(null, "asdb@gmail.com", "effefe", AcessType.ADMIN, "gggg", "464646", "Btere");
		UserCorpClient userCorp1 = new UserCorpClient(null, "FFF@gmail.com", "123", AcessType.CLIENT, "55555", "553535", "Gertrudes",
		...
		Product p2 = new Product(null, "fiat", "afwwgwg", "Barcao dos veio", Instant.parse("2014-06-20T19:53:07Z"),
				Instant.now(), u1);
